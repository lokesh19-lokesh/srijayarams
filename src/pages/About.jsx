    ...
    <>
      ...
      <Section className="py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            <span className="text-blue-400 font-bold tracking-wider uppercase mb-2 block">Our Vision</span>
            <h2 className="text-3xl font-bold mb-6 text-white">Shaping the future with integrity and excellence.</h2>
          ...
          <div>
            <span className="text-blue-400 font-bold tracking-wider uppercase mb-2 block">Our Mission</span>
            <h2 className="text-3xl font-bold mb-6 text-white">Delivering value through quality and trust.</h2>
            <p className="text-gray-400 leading-relaxed">
