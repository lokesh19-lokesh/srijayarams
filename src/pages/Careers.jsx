        ...
        <Section className="relative z-10 py-24">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={index} className="flex flex-col md:flex-row justify-between items-center p-6 border border-gray-700 rounded-xl hover:border-blue-500 transition-colors bg-[#1a1a1a]/80 backdrop-blur-sm">
