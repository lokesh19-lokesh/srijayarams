...
const Home = () => {
  ...
  return (
    <>
      ...
      />
      {/* <Hero /> - Commented out as per request */}
      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        {/* Overlay for better text readability if needed later */}
        <div className="absolute inset-0 bg-black/30" />

        {/* Dot Pattern Overlay - Tata Style */}
        <div
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 z-10">
          ...
          {/* <p className="text-xl md:text-2xl text-white/90 max-w-3xl drop-shadow-md">
            Empowering Lives, Building the Future Since 1974
          </p> */}
        </div>
      </div>
